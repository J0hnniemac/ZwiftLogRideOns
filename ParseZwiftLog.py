...
zwift_data = os.path.join(home, "Documents", "Zwift", "Logs")
...
rideon_total_file = os.path.join(output_path, "RideOnTotals.txt")
notification_file = os.path.join(output_path, "Notify.txt"
